...
<nav class="main_nav_bar">
	<ul class="main_nav">
		...
		<li class="dr dropdown2"><a> 문의/고객센터(추가예정) </a></li>
		<div class="dropdownContent2">
			<li><i class="bi bi-chat-dots"></i> <a href=""> 문의사항(추가예정) </a></li>
			<li><i class="bi bi-bell"></i> <a href=""> 공지사항(추가예정) </a></li>
		...
		<div class="dropdownContent">
			...
			<li><i class="bi bi-person-circle"></i><a href=""> 회원정보(추가예정) </a></li>
		</div>
