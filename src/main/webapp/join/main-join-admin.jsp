		...
		<div class="join_page">
			...
			<form action="adminJoin.join" method="post">
				...
				<div class="left">
					...
					<div class="name">
						<p>이름</p>
						<input type="text" id="adminName" name="adminName" style="text-align: left;"
							placeholder="이름을 입력하세요." required="required" oninput="validateAdminName()">
				...
				<div class="right">
					<div class="id">
						...
						<input type="text" id="adminId" name="adminId"
							...
							required="required" oninput="validateAdminId()">
						<button onclick="adminIdCheck()">중복확인</button>
						<div id="idResult"></div>
					</div>
					<div class="pw">
						<p>패스워드</p>
						<input type="password" id="adminPw" name="adminPw" style="text-align: left;"
							placeholder="비밀번호를 입력하세요." required="required" oninput="validatePassword()">
						<div id="pwLengthMessage" style="color: red; font-size: 12px; display: none;">비밀번호는 최소 4글자 이상이어야 합니다.</div>
					</div>
					<div class="pw">
						<p>비밀번호확인</p>
						<input type="password" id="adminPwre" name="adminPwre" style="text-align: left;"
							placeholder="비밀번호 재입력" required="required" oninput="validatePassword()">
					...
					<div class="email">
						<p>이메일</p>
						<input type="email" id="adminEmail" name="adminEmail" style="text-align: left;"
							placeholder="이메일을 입력하세요." required="required" oninput="validateAdminEmail()">
