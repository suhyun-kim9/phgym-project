...
<!--           <div>
                <a>이용일 : 마이페이지 - 예약하기 기능을 통해 날짜 선택 가능합니다.</a>
            </div> -->
            <div class="pay-method">
                <a>결제방법</a>
                <input type="text" name="payMethod" placeholder="직접입력" id="payMethod">
            ...
            <div>
                <a>결제금액</a>
                <input type="text" name="payAmount"  value="250000" readonly>
            </div>
	...
	<script>
		function myMethod(obj) { //결제방법 select
	        payMethod.value = obj;
	    }
	    
	    function myBank(obj) { //환불은행명 select
